const products = [
  ...
  },
  {
    ...
    discription:
      "The PlayStation 5 is a next-generation video game console developed by Sony Interactive Entertainment. It was released in November 2020 and is the successor to the PlayStation 4. The PlayStation 5 features a new hardware architecture, including a custom AMD Zen 2 CPU, a dedicated SSD, and faster I/O. The console also supports 4K/120FPS video output, 3D audio, and haptic feedback.",
  },
  {
    id: 5,
